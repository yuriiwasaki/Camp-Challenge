...
print date("Y年m月d日 H時i分s秒", time()).'<br>'; //時刻を正確にする方法はないものか？
...
// $sum1 != $diff1
//     strtotime("2015-10-01 12:20:33") != strtotime("2015-11-01 23:08:33")


echo strlen('いわさきゆり').'<br>';
echo mb_strlen('いわさきゆり').'<br>';

echo strlen('iwasaki yuri').'<br>';
echo mb_strlen('iwasaki yuri');
